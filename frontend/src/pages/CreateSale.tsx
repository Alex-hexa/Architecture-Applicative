  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-8">
      <div className="bg-white p-8 rounded-xl shadow-sm">
        <h2 className="text-2xl font-bold mb-6">Déposer une annonce</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-lbc-orange hover:bg-orange-600 text-white font-bold py-3 rounded-lg mt-6">
            Publier l'annonce
          </button>
        </form>
      </div>
